...
let subtitle : string | undefined = "Abdulfatai" // = undefined


// void used when a function does not return a useful value

function log(msg:string) :void { //it will not return anything
    console.log(msg);
...
const valueAny : any = JSON.parse('{"x" : 1}') //this complies but can break any time of run. dont use whenever yuo dont sure wheather its an object or number etc.
